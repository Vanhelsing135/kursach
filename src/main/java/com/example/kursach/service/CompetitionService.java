...
public class CompetitionService {
    ...
    @Transactional
    public List<Competition> getCompetitions(Pageable pageable) {
        if (true) {
...
//                teams.add(new Team(t.getId(), t.getName(), t.getShortName(), t.getTla(), t.getAddress(), t.getFounded(), t.getClubColors(), t.getVenue(), competitions, newPlayers));
            teamRepository.save(new Team(t.getId(), t.getName(), t.getShortName(), t.getTla(), t.getAddress(), t.getFounded(), t.getClubColors(), t.getVenue(), competitions, newPlayers, t.getCrest()));
